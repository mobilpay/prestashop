...
//    $this->page = basename(__FILE__, '.php');
    $this->displayName = $this->'mobilPay';
...
//$objPmReqCard->invoice->amount = $params['cart']->getOrderTotal(true, 3);
  ...
  function validateOrder($id_cart, $id_order_state, $amount_paid, $payment_method = 'Unknown', $message = null, $extra_vars = array(), $currency_special = null, $dont_touch_amount = false, $secure_key = false, Shop $shop = null)
  {
    ...
    parent::validateOrder($id_cart, $id_order_state, $amountPaid, $paymentMethod, $message, $extraVars, $currency_special, true, $secure_key, null);
  }
}
